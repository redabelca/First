...
var lib = {
  ...
  toggle2Css: function (el, css1, css2) {
    if (lib.hasClass(el, css1)) {
      el.className.replace(css1, css2);
    } else if (lib.hasClass(el, css2)) {
      el.className.replace(css2, css1);
    } else {
...
function t (el, css1, css2) {
    if (el.classList.contains(css1)) {
      el.className=el.className.replace(css1, css2);console.log(el.className);
    } else if (el.classList.contains(css2)) {
      el.className=el.className.replace(css2, css1);console.log(el.className);
    } else {
      alert('error in lib.toggle2Css');
    }
  }
